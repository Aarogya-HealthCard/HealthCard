...
//echo $res;
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        if(isset($_POST['submit'])){
            ...
            $img=$img.$filename;
            $query=$mysqli->query("INSERT INTO  u_labtest(u_id,utest,udate,result,unit,img,notes) VALUES ('$uid','$test','$udate',$result,$unit,'$img','$note')");
            
           
        }
    }
    $disp=$mysqli->query("SELECT * from u_labtest");
    ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                    ...
                    <div id="panel-1" class="panel panel-default">
                        <div class="panel-heading">
                            <span class="title elipsis">
                                <strong style="text-transform: uppercase;font-weight: bold;">Lab Test</strong>
                                 <!-- panel title -->
                            </span>
                        ...
                        <div class="panel-body">
                            <h4>It contains lab test that you have added.</h4>
                        </div>
                        <!-- /panel content -->
                    </div>
                    <!-- /PANEL -->
                ...
                <p>Please add your lab test details here.</p>
                <!--===================================================-->
                <!--End page content-->
                    ...
                    <div id="panel-1" class="panel panel-default" >
                        <div class="panel-heading">
                               <div id="page-title">
                                 ...
                                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD LAB TEST</button>
                            <div class="modal fade" id="myModal" role="dialog" >
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title">ADD LAB TEST</h6>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        </div>
                                        <form method="POST" action="" enctype="multipart/form-data">
                                        <div class="modal-body">
                                                                   
                                                 <label for="inputEmail4">Lab Test:</label>
                                                 <input type="text" class="form-control" name="test" placeholder="Please Enter Test Here">
                                                 <br>
                                                 <label for="inputEmail4">Performed On:</label>
                                                 <input type="text" class="form-control" name="udate" placeholder="dd/mm/yy" id="dateLab">
                                                 <br>
                    ...
                    <div class="searchbox">
                        <div class="input-group custom-search-form">
                            <input type="text" class="form-control" placeholder="Search Lab Test..">
                            <span class="input-group-btn">
                                <button class="text-muted" type="button"><i class="demo-pli-magnifi-glass"></i></button>
                            </span>
                        </div>
                           ...
                           <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li>
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li><a href="#"><i class="fa fa-flask"></i>Lab Tests</a></li>
