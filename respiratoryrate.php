...
$my=$mysqli->query("SELECT u_id from u_gen_info WHERE u_id='$uid'");
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        if(isset($_POST['submit'])){
            ...
            $udate=$_POST['udate'];
            $note=$_POST['note'];
            $query=$mysqli->query("INSERT INTO  u_respiratoryrate(u_id,result,udate,notes) VALUES ('$uid','$result','$udate','$note')");  
               
        }
    }  
    $disp=$mysqli->query("SELECT * from u_respiratoryrate");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                    ...
                    <div id="panel-1" class="panel panel-default">
                        <div class="panel-heading">
                            <span class="title elipsis">
                                <strong style="text-transform: uppercase;font-weight: bold;">Respiratory Rate
                                </strong>
                                 <!-- panel title -->
                            </span>
                        ...
                        <div class="panel-body">
                            <h4>It contains respiratory rate that you have added.</h4>
                        </div>
                        <!-- /panel content -->
                    </div>
                    <!-- /PANEL -->
                ...
                <p>Please add your respiratory rate details here.</p>
                <!--===================================================-->
                <!--End page content-->
                    ...
                    <div id="panel-1" class="panel panel-default" >
                        <div class="panel-heading">
                               <div id="page-title">
                                 ...
                                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD RESPIRATORY RATE</button>
                            <div class="modal fade" id="myModal" role="dialog" >
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title">ADD RESPIRATORY RATE</h6>
                                        ...
                                        <div class="modal-body">
                                                 ...
                                                 <input type="text" class="form-control" name="result" placeholder="4-100 (breaths per minute)">
                                                 <br>
                                                 <label for="inputEmail4">Collection Date:</label>
                                                 <input type="text" class="form-control" name="udate" placeholder="dd/mm//yy" id="dateRr">
                                                 <br>
                                    ...
                                    <!--Menu list item-->
                                     <li>
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li><a href="#"><img src="assets/rr2.png" height="15" width="15"> Respiratory Rate</a></li>                                     
                                        </ul>
                                    </li>
