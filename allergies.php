...
$my=$mysqli->query("SELECT u_id from u_gen_info WHERE u_id='$uid'");
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        if(isset($_POST['submit'])){
            ...
            $query=$mysqli->query("INSERT INTO  u_allergy(u_id,allergy,choice,duration,numb,severity,notes) VALUES ('$uid','$allergy','$choice','$duration','$numb','$severity','$note')");
          
            
        }
    }
    $disp=$mysqli->query("SELECT * from u_allergy");
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                    ...
                    <div id="panel-1" class="panel panel-default">
                        <div class="panel-heading">
                            <span class="title elipsis">
                                <strong style="text-transform: uppercase;font-weight: bold;">Allergies</strong>
                                 <!-- panel title -->
                            </span>
                        ...
                        <div class="panel-body">
                            <h4>It contains allergies that you have added.</h4>
                        </div>
                        <!-- /panel content -->
                    </div>
                    <!-- /PANEL -->
                ...
                <p>Please add your allergies details here.</p>
                <!--===================================================-->
                <!--End page content-->
                    ...
                    <div id="panel-1" class="panel panel-default" >
                        <div class="panel-heading">
                               <div id="page-title">
                                 ...
                                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD ALLERGY</button>
                            <div class="modal fade" id="myModal" role="dialog" >
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title">ADD ALLERGY</h6>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        </div>
                                        <form method="POST" action="">  
                                        <div class="modal-body">
                                                                 
                                                 <label for="inputEmail4">Allergy:</label>
                                                 <input type="text" class="form-control" name="allergy" placeholder="Enter Allergy">
                                                 <br>   
                                                 <label class="form-check-label" for="gridCheck">Do you still have this allergy?
                                                 </label><br>
                                                 ...
                                                 <br>
                                                 <input type="number" name="numb" class="form-control" min="1">
                                                 <br>
                                                 <label for="inputEmail4">Severity:</label>
                                                 <select class="form-control" name="severity">
                                                    ...
                                                    <option>Life Threatening Severity</option>
                                                </select>
                                                 <br>
                        ...
                        <div class="nano">
                           ...
                           <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li>
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li><a href="#"><i class="fa fa-pagelines"></i>Allergies</a></li>
