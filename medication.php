...
//echo $res;
    ...
    $disp=$mysqli->query("SELECT * from u_medication");
    ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form> 
                                                ...
                                                <table class="table"  id="dynamic_field"> 
                                                   <tr> 
                                                   <td>          
                                                    <div id="category_div">Select Disease:
                                                ...
                                                <td>
                                                    <div id="sub_category_div">Select Medicine:
                                                        <script type="text/javascript" language="JavaScript">
                                                        document.write('<select name="subcategory" id="subcategory"><option value="">Select                                      Medicine</option></select>')
                                                        </script>
                                                        <noscript>
    ...
    <script src = "https://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td>select name="category" class="required-entry" id="category" onchange="javascript: dynamicdropdown(this.options[this.selectedIndex].value);"><option value="">Select Disease</option> <option value="Cancer">Cancer</option> <option value="Typhoid">Typhoid</option> <option value="Malaria">Malaria</option> <option value="Fever">Fever</option></select></td><td><td><input type="number" class="form-control" name="u_dosage[]" min="1" name="dose" id="dose" placeholder="Pills/Drops/Tsp"></td><td><select class="form-control"><option value="Day">Day</option> <option value="Noon">Noon</option><option value="Night">Night</option><option value="Day-Night">Day-Night</option><option value="Day-Noon-Night">Day-Noon-Night</option> </select></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });  
          ...
          function dynamicdropdown(listindex)
            {
                ...
                {
                    case "Cancer" :
                        document.getElementById("subcategory").options[0]=new Option("Please select medicine","");
                        document.getElementById("subcategory").options[1]=new Option("Arimidex","Arimidex");
                        document.getElementById("subcategory").options[2]=new Option("Bosulif","Bosulif");
                        document.getElementById("subcategory").options[3]=new Option("Fludara","Fludara");
                        document.getElementById("subcategory").options[4]=new Option("Gemzar","Gemzar");
                        document.getElementById("subcategory").options[5]=new Option("Hydrea","Hydrea");
                        break;
                    
                    case "Typhoid" :
                        document.getElementById("subcategory").options[0]=new Option("Please select medicine","");
                        document.getElementById("subcategory").options[1]=new Option("Cipro","Cipro");
                        document.getElementById("subcategory").options[2]=new Option("Zithromax","Zithromax");
                        break;
                    case "Malaria" :
                        document.getElementById("subcategory").options[0]=new Option("Please select medicine","");
                        document.getElementById("subcategory").options[1]=new Option("Malarone","Malarone");
                        document.getElementById("subcategory").options[2]=new Option("Vibramycin","Vibramycin");
                        document.getElementById("subcategory").options[3]=new Option("Mefloquine","Mefloquine");
                        document.getElementById("subcategory").options[4]=new Option("Monodox","Monodox");
                        break;
                    case "Fever" :
                        document.getElementById("subcategory").options[0]=new Option("Please select framework","");
                        document.getElementById("subcategory").options[1]=new Option("Paracetamol","Paracetamol");
                        break;
                }
                return true;
            }
