...
$my=$mysqli->query("SELECT u_id from u_gen_info WHERE u_id='$uid'");
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        if(isset($_POST['submit'])){
            ...
            $udate=$_POST['udate'];
            $note=$_POST['note'];
            $query=$mysqli->query("INSERT INTO  u_bmi(u_id,uweight,uheight,bmi,udate,notes) VALUES ('$uid','$uweight','$uheight','$bmi','$udate','$note')");  
           
        }
    }  
     $disp=$mysqli->query("SELECT * from u_bmi");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                    ...
                    <div id="panel-1" class="panel panel-default">
                        <div class="panel-heading">
                            <span class="title elipsis">
                                <strong style="text-transform: uppercase;font-weight: bold;">BMI</strong>
                                 <!-- panel title -->
                            </span>
                        ...
                        <div class="panel-body">
                            <h4>It contains BMI that you have added.</h4>
                        </div>
                        <!-- /panel content -->
                    </div>
                    <!-- /PANEL -->
                ...
                <p>Please add your BMI details here.</p>
                <!--===================================================-->
                <!--End page content-->
                    ...
                    <div id="panel-1" class="panel panel-default" >
                        <div class="panel-heading">
                               <div id="page-title">
                                 ...
                                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD BMI</button>
                            <div class="modal fade" id="myModal" role="dialog" >
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title">ADD BMI</h6>
                                        ...
                                        <div class="modal-body">
                                                 ...
                                                 <input type="text" class="form-control" name="uweight" placeholder="Enter value between 5 to 300">
                                                 <br>
                                                 <label for="inputEmail4" >Height(cm):</label>
                                                 <input type="text" class="form-control" name="uheight" placeholder="Enter value between 5 to 300">
                                                 <br>
                                                 <label for="inputEmail4">BMI:</label>
                                                 <input type="text" class="form-control" name="bmi" >
                                                 <br>
                                                 <label for="inputEmail4">Date:</label>
                                                 <input type="text" class="form-control" name="udate" placeholder="dd/mm/yy" >
                                                 <br>
                                        ...
                                        <script>
                                            const weightInput = document.getElementById('uweight');
                                            const heightInput = document.getElementById('uheight');
                                            const bmiInput = document.getElementById('bmi');    
                                            heightInput.addEventListener('input', calculateBMI);
                                            weightInput.addEventListener('input', calculateBMI);
                                            function calculateBMI () {
                                                const uheight = parseFloat(heightInput.value);
                                                const uweight = parseFloat(weightInput.value);
                                                const bmi = uweight / Math.pow(uheight, 2);
                           ...
                           <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li>
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li><a href="#"><img src="assets/bmi2.png" height="15" width="15"> BMI</a></li>
