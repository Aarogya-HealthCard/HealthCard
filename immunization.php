...
$my=$mysqli->query("SELECT u_id from u_gen_info WHERE u_id='$uid'");
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        if(isset($_POST['submit'])){
            ...
            $udate=$_POST['udate'];
            $note=$_POST['note'];
            $query=$mysqli->query("INSERT INTO  u_immunization(u_id,immunization,udate,notes) VALUES ('$uid','$immunization','$udate','$note')");  
            
            echo("Error:".$mysqli->error);    
        }
    }  
    $disp=$mysqli->query("SELECT * from u_immunization");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                    ...
                    <div id="panel-1" class="panel panel-default">
                        <div class="panel-heading">
                            <span class="title elipsis">
                                <strong style="text-transform: uppercase;font-weight: bold;">Immunization</strong>
                                 <!-- panel title -->
                            </span>
                        ...
                        <div class="panel-body">
                            <h4>It contains immunization that you have added.</h4>
                        </div>
                        <!-- /panel content -->
                    </div>
                    <!-- /PANEL -->
                ...
                <p>Please add your immunization details here.</p>
                <!--===================================================-->
                <!--End page content-->
                    ...
                    <div id="panel-1" class="panel panel-default" >
                        <div class="panel-heading">
                               <div id="page-title">
                                 ...
                                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD IMMUNIZATION</button>
                            <div class="modal fade" id="myModal" role="dialog" >
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title">ADD IMMUNIZATION</h6>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        </div>
                                        <form method="POST" action="">
                                        <div class="modal-body">
                                                                   
                                                 <label for="inputEmail4">Immunization:</label>
                                                 <input type="text" class="form-control" name="immunization" placeholder="Enter Immunization">
                                                 <br>
                                                 <label for="inputEmail4">Taken On:</label>
                                                 <input type="text" class="form-control" name="udate" placeholder="dd/mm/yy" id="dateIm">
                                                 <br>
                    ...
                    <div class="searchbox">
                        <div class="input-group custom-search-form">
                            <input type="text" class="form-control" placeholder="Search Immunization..">
                            <span class="input-group-btn">
                                <button class="text-muted" type="button"><i class="demo-pli-magnifi-glass"></i></button>
                            </span>
                        </div>
                           ...
                           <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li>
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li><a href="#"><img src="assets/imm2.png" height="15" width="15"> Immunizations</a></li>
