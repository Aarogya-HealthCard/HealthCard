...
//echo $res;
    ...
    $disp=$mysqli->query("SELECT * from u_prescription");
    ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                    ...
                    <div id="panel-1" class="panel panel-default">
                        <div class="panel-heading">
                            <span class="title elipsis">
                                <strong style="text-transform: uppercase;font-weight: bold;">Prescriptions</strong>
                                 <!-- panel title -->
                            </span>
                        ...
                        <div class="panel-body">
                            <h4>It contains prescriptions that you have added.</h4>
                        </div>
                        <!-- /panel content -->
                    </div>
                    <!-- /PANEL -->
                ...
                <p>Please add your prescription details here.</p>
                <!--===================================================-->
                <!--End page content-->
                    ...
                    <div id="panel-1" class="panel panel-default" >
                        <div class="panel-heading">
                               <div id="page-title">
                                 ...
                                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD PRESCRIPTION</button>
                            <div class="modal fade" id="myModal" role="dialog" >
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title">ADD PRESCRIPTION</h6>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        </div>
                                         <form method="POST" action="" enctype="multipart/form-data">
                                        <div class="modal-body">
                                                                  
                                                 <label for="inputEmail4">Hospital/Clinic:</label>
                                                 <input type="text" class="form-control" name="u_hospital" placeholder="Hospital/Clinic">
                                                 <br>
                                                 <label for="inputEmail4">Doctor:</label>
                                                 <input type="text" class="form-control"  name="u_doctor" placeholder="Doctor">
                                                 <br>
                                                 <label for="inputEmail4">Prescribed on:</label>
                                                 <input type="text" class="form-control" name="u_date" placeholder="dd/mm//yy" id="preDate">
                                                 <br>
                                                 <label for="inputEmail4">Phone:</label>
                                                 <input type="text" class="form-control" name="u_phone" placeholder="Phone" maxlength="10">
                                                 <br> 
                                                 <label for="inputEmail4">Address:</label>
                                                 <textarea rows="3" cols="38" name="u_address" class="form-control"> </textarea>        
                                                 <br>  
                                                 <label for="inputEmail4">Notes:</label>
                                                 <textarea rows="3" cols="38" name="notes" class="form-control">
                                                 </textarea> 
                                                 <br>
                                                 <div class="container">
                            ...
                            <div class="table-responsive">
                               ...
                               echo "<table class='table table-bordered table-hover'>
                                        ...
                                        while($row=mysqli_fetch_array($disp))
                                        {
                                            ...
                                            echo "<td>".$row['u_hospital']."</td>";
                                            echo "<td>".$row['u_doctor']."</td>";
