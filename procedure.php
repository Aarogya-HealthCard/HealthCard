...
//echo $res;
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        if(isset($_POST['submit'])){
            ...
            $img=$img.$filename;
            $query=$mysqli->query("INSERT INTO  u_procedure(u_id,u_pro,u_perform,u_date,u_report,u_notes) VALUES ('$uid','$upro','$uperform','$udate','$img','$note')");
               
           
        }
    }
    $disp=$mysqli->query("SELECT * from u_procedure");
    ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                    ...
                    <div id="panel-1" class="panel panel-default">
                        <div class="panel-heading">
                            <span class="title elipsis">
                                <strong style="text-transform: uppercase;font-weight: bold;">Procedures</strong>
                                 <!-- panel title -->
                            </span>
                        ...
                        <div class="panel-body">
                            <h4>It contains procedures that you have added.</h4>
                        </div>
                        <!-- /panel content -->
                    </div>
                    <!-- /PANEL -->
                ...
                <p>Please add your procedures details here.</p>
                <!--===================================================-->
                <!--End page content-->
                    ...
                    <div id="panel-1" class="panel panel-default" >
                        <div class="panel-heading">
                               <div id="page-title">
                                 ...
                                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD PROCEDURE</button>
                            <div class="modal fade" id="myModal" role="dialog" >
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title">ADD PROCEDURE</h6>
                                        ...
                                        <div class="modal-body">
                                                 ...
                                                 <input type="text" class="form-control" name="u_pro" placeholder="Please Enter Procedure">
                                                 <br>
                                                 <label for="inputEmail4">Performed By:</label>
                                                 <input type="text" class="form-control" name="u_perform" placeholder="Doctor/Hospital">
                                                 <br>
                                                 <label for="inputEmail4">Date:</label>
                                                 <input type="text" class="form-control" name="u_date" placeholder="dd/mm/yy" id="datePr">
                                                 <br>
                                                 <label>Report:</label>
                                                 ...
                                                 <textarea rows="3" cols="38"  name="u_notes" class="form-control">
                                                 </textarea> 
                            ...
                            <div class="table-responsive">
                               ...
                               echo "<table class='table table-bordered table-hover'>
                                        ...
                                        while($row=mysqli_fetch_array($disp))
                                        {
                                            ...
                                            echo "<td>".$row['u_pro']."</td>";
                                            echo "<td>".$row['u_perform']."</td>";
                                            echo "<td>".$row['u_report']."</td>";
                           ...
                           <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li>
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li><a href="#"><img src="assets/pr3.png" height="15" width="15"> Procedures</a></li>
