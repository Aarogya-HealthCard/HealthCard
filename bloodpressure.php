...
$my=$mysqli->query("SELECT u_id from u_gen_info WHERE u_id='$uid'");
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        if(isset($_POST['submit'])){
            ...
            $udate=$_POST['udate'];
            $note=$_POST['note'];
            $query=$mysqli->query("INSERT INTO  u_bloodpressure(u_id,systolic,diastolic,udate,notes) VALUES ('$uid','$systolic','$diastolic','$udate','$note')");
            
        }
    }
    $disp=$mysqli->query("SELECT * from u_bloodpressure");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                    ...
                    <div id="panel-1" class="panel panel-default">
                        <div class="panel-heading">
                            <span class="title elipsis">
                                <strong style="text-transform: uppercase;font-weight: bold;">Blood Pressure</strong>
                                 <!-- panel title -->
                            </span>
                        ...
                        <div class="panel-body">
                            <h4>It contains blood pressure that you have added.</h4>
                        </div>
                        <!-- /panel content -->
                    </div>
                    <!-- /PANEL -->
                ...
                <p>Please add your blood pressure details here.</p>
                <!--===================================================-->
                <!--End page content-->
                    ...
                    <div id="panel-1" class="panel panel-default" >
                        <div class="panel-heading">
                               <div id="page-title">
                                 ...
                                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD BLOOD PRESSURE</button>
                            <div class="modal fade" id="myModal" role="dialog" >
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="modal-title">ADD BLOOD PRESSURE</h6>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        </div>
                                        <form method="POST" action="">    
                                        <div class="modal-body">                
                                                 <label for="inputEmail4">Systolic:</label>
                                                 <input type="text" name="systolic"  class="form-control" placeholder="Sys(30-270 mmHg)">
                                                 <br>
                                                 <label for="inputEmail4">Diastolic:</label>
                                                 <input type="text" name="diastolic" class="form-control" placeholder="Dia (10-245 mmHg)">
                                                 <br>
                                                 <label for="inputEmail4">Date:</label>
                                                 <input type="text" name="udate" class="form-control" placeholder="dd/mm//yy" id="dateBp">
                                                 <br>
                           ...
                           <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <!--Menu list item-->
                                     <li>
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li><a href="#"><img src="assets/bp.png" height="15" width="15"> Blood Pressure</a></li>
